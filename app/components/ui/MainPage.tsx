    ...
    return (
        <div className="flex flex-col md:flex-row items-center md:items-center gap-8">
            ...
            <div className="flex-1">
                <h2 className="text-4xl mb-4 text-center text-[#7de2d1]">
                ...
                <div className="text-center">
                    ...
                    <Modal backdrop="blur" isOpen={researchDisclosure.isOpen} onOpenChange={researchDisclosure.onOpenChange}>
                        <ModalContent className="bg-[#131515]">
                            {(onClose) => (
                                <>
                                    <ModalHeader className="flex flex-row gap-1 text-[#7de2d1]">Research</ModalHeader>
                                    <ModalBody className="text-[#fffafb]">
                                        <p>
                ...
                <div className="text-center">
                    ...
                    <Modal backdrop="blur" isOpen={missionDisclosure.isOpen} onOpenChange={missionDisclosure.onOpenChange}>
                        <ModalContent className="bg-[#131515]">
                            {(onClose) => (
                                <>
                                    <ModalHeader className="flex flex-row gap-1 text-[#7de2d1]">Mission</ModalHeader>
                                    <ModalBody className="text-[#fffafb]">
                                        <p>
